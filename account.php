<?php
	$servernames = "localhost";//hostname
	$usernames = "store";//zephyrus store mysql username
	$passwords = "password**";//zephyrus store mysql password
	$dbnames = "store";//zephyrus store mysql database
					...
					<div id="account-info" class="col-md-12">
						<div class="statistics-box">
							...
							<div class="statistics-content">
								Steam ID 32 : <?php print($str); if(empty($results[0]['steamid'])){} ?> </br>
								Steam ID 64 : <?php print($linkedsteaminfo); if(empty($results[0]['steamid'])){ print('<div id="steam-login-container-account">'); loginbutton('rectangle'); print('</div>'); } ?>
...
$sql3 = "SELECT credits FROM store_players WHERE authid = '$str2'";
$result = $conn->query($sql3);
?>
		<div id="purchase-statistics" class="statistics-box">
							<div class="statistics-title">Store Credits</div>
							<div class="statistics-content">
	...
	echo "We can't find you in our database just yet, Maybe you haven't played on our servers.";
}
?>
</div>
						<?php
